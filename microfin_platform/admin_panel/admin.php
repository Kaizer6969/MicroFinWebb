...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'save_credit_policy') {
    ...
    $credit_policy_redirect_tab = (string)($_POST['credit_policy_tab'] ?? 'overview');
    $credit_policy_redirect_tab = in_array($credit_policy_redirect_tab, ['overview', 'eligibility', 'score', 'limit', 'ci', 'product'], true)
                            ...
                            <div class="card-header-flex">
                                ...
                                <script>
                                    function openAddStaffModal() {
                                        ...
                                        var manualSetup = document.getElementById('create-manual-setup');

                                        var manualFields = document.getElementById('manual-setup-fields');

                                        var manualUser = document.getElementById('manual-username');

                                        var manualPass = document.getElementById('manual-password');

                                        if (manualSetup) manualSetup.checked = false;

                                        if (manualFields) manualFields.style.display = 'none';

                                        if (manualUser) manualUser.required = false;

                                        if (manualPass) manualPass.required = false;
                ...
                <div class="modal-body">
                    ...
                    <div id="staff-fill-now-fields" style="display: none; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="date" class="form-control" name="date_of_birth" id="staff-date-of-birth">
                        </div>
                    </div>
        ...
        (function() {
            ...
            function setPolicyTab(tabName) {
                ...
                if (activeTabInput) {
                    ...
                    activeTabInput.value = activeTab || 'overview';
