                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group form-full">
                            <label style="display:flex;align-items:center;gap:8px;cursor:pointer;">
                                <input type="checkbox" name="documents_complete" id="documentsComplete" value="1"
                        ...
                        <div class="form-group form-full">
                                ...
                                <?php foreach ($document_types as $doc): ?>
                                    <div class="doc-item">
                                        ...
                                        <span class="doc-item-label">
                                            ...
                                            <?php if ($doc['is_required']): ?><span
                                                    class="doc-badge">Required</span><?php endif; ?>
                                        </span>
                            ...
                            <p class="form-hint" style="margin-top:8px;">Upload each collected document. Missing items
                                can be followed-up later via Draft.</p>
                        </div>
                        <div class="form-group form-full">
                            <label>Missing / Follow-up Notes</label>
                            <textarea name="missing_documents_notes"
                                placeholder="List pending documents or remarks…"></textarea>
                        </div>
                    </div>
                </form>
            </div>
