...
DROP DATABASE IF EXISTS microfin_db;
...
CREATE TABLE IF NOT EXISTS tenants (
    ...
    max_clients INT DEFAULT 1000 COMMENT '1000=Starter, 2500=Growth, 5000=Pro, 10000=Enterprise, -1=Unlimited',
    max_users INT DEFAULT 250 COMMENT '250=Starter, 750=Growth, 2000=Pro, 5000=Enterprise, -1=Unlimited',
...
CREATE TABLE IF NOT EXISTS clients (
    ...
    -- Comaker Info (⚠ CONSIDER: extract to separate comakers table?)
    ...
    registered_by INT,
    document_verification_status ENUM('Unverified', 'CONSIDER', 'EDITED', 'Rejected') DEFAULT 'Unverified',
...
CREATE TABLE IF NOT EXISTS client_documents (
    ...
    verification_status ENUM('CONSIDER', 'Verified', 'Rejected', 'Expired') DEFAULT 'CONSIDER',
...
CREATE TABLE IF NOT EXISTS loan_applications (
    ...
    EDITED_amount DECIMAL(12, 2),
    loan_term_months INT NOT NULL,
    interest_rate DECIMAL(5, 2) NOT NULL,
    loan_purpose TEXT,
    application_data JSON,
    application_status ENUM(
        'Draft', 'Submitted', 'CONSIDER', 'Under Review',
        'Document Verification', 'Credit Investigation',
        'For Approval', 'EDITED', 'Rejected', 'Cancelled', 'Withdrawn'
    ) DEFAULT 'Draft',
    ...
    -- Comaker (⚠ CONSIDER: extract to separate table?)
    ...
    FOREIGN KEY (EDITED_by) REFERENCES employees(employee_id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS amortization_schedule (
    ...
    payment_status ENUM('CONSIDER', 'Paid', 'Overdue', 'Partially Paid') DEFAULT 'CONSIDER',
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    payment_status ENUM('CONSIDER', 'Posted', 'Verified', 'Cancelled', 'Bounced') DEFAULT 'CONSIDER',
    remarks TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (loan_id) REFERENCES loans(loan_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS payment_transactions (
    ...
    status ENUM('CONSIDER', 'completed', 'failed', 'cancelled') DEFAULT 'CONSIDER',
...
CREATE TABLE IF NOT EXISTS credit_investigations (
    ...
    status ENUM('CONSIDER', 'Completed', 'Cancelled') DEFAULT 'CONSIDER',
...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    notification_type ENUM(
        'Payment Due', 'Payment Received', 'Loan EDITED', 'Loan Rejected',
...
CREATE TABLE IF NOT EXISTS tenant_website_content (
    ...
    about_body TEXT,
    about_image_path VARCHAR(500),

    -- Services Section
    services_heading VARCHAR(255) DEFAULT 'Our Services',
    services_json LONGTEXT COMMENT 'JSON array of service cards',
