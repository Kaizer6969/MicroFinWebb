...
class _LoanDetailsScreenState extends State<LoanDetailsScreen> {
    ...
    if (loanNum == null) {
      ...
      try {
        final myLoansUrl = Uri.parse(
          ApiConfig.getUrl('api_get_my_loans.php?user_id=${currentUser.value!['user_id']}&tenant_id=$tenantId')
        );
  ...
  Future<void> _loadLoan(String loanNum, String tenantId) async {
    try {
      final url = Uri.parse(
        ApiConfig.getUrl('api_get_loan_details.php?loan_number=$loanNum&tenant_id=$tenantId')
      );
                ...
                child: Stack(children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      Text('₱${getNum(loan['remaining_balance']).toStringAsFixed(0)} left', style: const TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w700)),
                    ]),
  ...
  Widget _detailRow(String label, String value, Color primary, {bool highlight = false, bool isFirst = false, bool isLast = false}) {
    return Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Text(value, style: TextStyle(fontSize: highlight ? 16 : 14, fontWeight: FontWeight.w800, color: highlight ? primary : const Color(0xFF111827))),
      ]),
    );
  }
