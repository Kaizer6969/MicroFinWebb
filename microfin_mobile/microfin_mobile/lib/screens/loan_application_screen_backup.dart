             ...
             Container(
               ...
               child: Column(
                 children: [
                   ...
                   Text('₱${_loanAmount.toStringAsFixed(0)}', style: const TextStyle(fontSize: 48, fontWeight: FontWeight.w900, color: Color(0xFF0F172A), letterSpacing: -1.5, height: 1.0)),
                   const SizedBox(height: 24),
                   SliderTheme(
           ...
           Container(
             ...
             child: Column(
               children: [
                 ...
                 const SizedBox(height: 4),
                 Text('₱${_loanAmount.toStringAsFixed(0)}', style: const TextStyle(color: Colors.white, fontSize: 44, fontWeight: FontWeight.w900, letterSpacing: -1)),
                 const SizedBox(height: 24),
                 ...
                 Row(
                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                   children: [
                     _reviewMetric('Monthly Pay', '₱${_monthly.toStringAsFixed(0)}'),
                     _reviewMetric('Interest', '${_rate * 100 ~/ 1}%'),
                     _reviewMetric('Total Pay', '₱${(_monthly * _selectedTerm).toStringAsFixed(0)}'),
                   ],
                 )
               ],
             ),
